...
class Output(LutronEntity):
    ...
    def _do_query_level(self) -> None:
        ...
        self._lutron.send(
            OP_QUERY, Output._CMD_TYPE, self._integration_id, Output._ACTION_ZONE_LEVEL
        )
    ...
    def set_level(
        self, new_level: float, fade_time_seconds: Optional[float] = None
    ) -> None:
        """Sets the new output level."""
        ...
        self._lutron.send(
            ...
            "%.2f" % new_level,
            self._fade_time(fade_time_seconds),
        )
    ...
    def is_dimmable(self) -> bool:
        ...
        return self.type not in (
            ...
            "RELAY_LIGHTING",
            "SWITCHED_MOTOR",
        ) and not self.type.startswith("CCO_")
